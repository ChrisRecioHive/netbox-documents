...
### CableDocument
class CableDocumentView(generic.ObjectView):
    queryset = models.CableDocument.objects.all()


class CableDocumentListView(generic.ObjectListView):
    queryset = models.CableDocument.objects.all()
    table = tables.CableDocumentTable
    filterset = filtersets.CableDocumentFilterSet
    filterset_form = forms.CableDocumentFilterForm


class CableDocumentEditView(generic.ObjectEditView):
    queryset = models.CableDocument.objects.all()
    form = forms.CableDocumentForm

    template_name = "netbox_documents/cabledocument_edit.html"


class CableDocumentDeleteView(generic.ObjectDeleteView):
    queryset = models.CableDocument.objects.all()
