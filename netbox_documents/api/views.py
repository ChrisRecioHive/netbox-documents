...
from .serializers import (
    CableDocumentSerializer,
    SiteDocumentSerializer,
    LocationDocumentSerializer,
    DeviceDocumentSerializer,
    DeviceTypeDocumentSerializer,
    CircuitDocumentSerializer,
)


class CableDocumentViewSet(NetBoxModelViewSet):
    queryset = models.CableDocument.objects.prefetch_related("tags")
    serializer_class = CableDocumentSerializer
    filterset_class = filtersets.CableDocumentFilterSet
